...
There were four of these total, each worth 5 points (2 pts for initial submission; 3 for self-assessment). A curve of 10 pts was added to the final sum.
...
ilabs_grades <- ilabs %>% 
  ...
  mutate(ilab_curved = ilab_prop + 10)
